                        ...
                        <tbody id='body-data'>
                            @if(@isset($data) && !@empty($data))
                                ...
                                @foreach($data as $row)
                                        ...
                                        <td>
                                            <div class='dropdown'>
                                                ...
                                                <div class='dropdown-menu' style='position: absolute; transform: translate3d(2px, 35px, 0px); top: 0px; left: 0px; will-change: transform;' x-placement='bottom-start'>
                                                    <form action="{{ route( 'show_postpone')}}" type='submit' method='post'>
                                                        @csrf
                                                    ...
                                                    <form action="{{ route( 'appointed_postpone')}}" type='submit' method='post'>
                                                        @csrf
                                                        <input type='hidden' id='id' name='id' value="{{ $row->employee_id }}">
                                    ...
                                    <form action="{{ route( 'delete_postpone')}}" method='post'>
                                        @csrf
