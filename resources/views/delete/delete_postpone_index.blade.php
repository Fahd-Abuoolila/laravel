...
<html lang='ar'>
    <head>
        ...
        <style>
            ...
            .menu > ul > li:nth-child(3) > a + ul > li:nth-child(2) > a{
                        ...
                        <tbody id='body-data'>
                            @if(@isset($data) && !@empty($data))
                                ...
                                @foreach($data as $row)
                                        ...
                                        <td>
                                            <div class='dropdown'>
                                                ...
                                                <div class='dropdown-menu' style='position: absolute; transform: translate3d(2px, 35px, 0px); top: 0px; left: 0px; will-change: transform;' x-placement='bottom-start'>
                                                    <form action="{{ route( 'show_delete_postpone_index')}}" type='submit' method='post'>
                                                        @csrf
                                    ...
                                    <form action="{{ route( 'delete_postpone_forever')}}" method='post'>
                                        @csrf
