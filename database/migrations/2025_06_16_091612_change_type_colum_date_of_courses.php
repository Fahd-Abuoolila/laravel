...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('employees_specific', function (Blueprint $table) {
            $table->string('course_date_1',100)->nullable()->change();
            $table->string('course_date_2',100)->nullable()->change();
            $table->string('course_date_3',100)->nullable()->change();
            $table->string('course_date_4',100)->nullable()->change();
            $table->string('course_date_5',100)->nullable()->change();
        });
